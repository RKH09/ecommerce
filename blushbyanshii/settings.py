...
STATIC_ROOT = os.path.join(os.path.dirname(NEW_BASE_DIR), 'static_cdn', 'static_root')
print (STATIC_ROOT)

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(os.path.dirname(NEW_BASE_DIR), 'static_cdn', 'media_root')
